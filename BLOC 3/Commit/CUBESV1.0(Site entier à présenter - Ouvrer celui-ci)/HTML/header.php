...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../css/themes/styles-page-tech.css">
  ...
  <link rel="stylesheet" type="text/css" href="../css/Unique-them/styles-globaux-pages-themes.css">
...
if (isset($_POST['accept_cookies']) == true) {
    ...
    setcookie('accept_cookies', 'true', time() + (300), '/');
}
?>
<body>
  <header>
...
<nav class="navbar navbar-dark bg-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php">LetMeThink</a>
          ...
          <li class="nav-item dropdown">
            ...
            <?php
              ...
              if (!isset($_SESSION['Connect'])) {
                echo '<li><a class="dropdown-item" href="ConnexionInscript.php">Connexion</a></li>';
              }
              ?>
              <?php
              //Maintenir la connexion
              if (isset($_SESSION['Connect'])) {
                echo '<li><a class="dropdown-item" href="Changement.php">Gestion du compte</a></li>';
                echo '<li><hr class="dropdown-divider"></li>';
                echo '<li><a class="dropdown-item" href="logout.php">Se déconnecter</a></li>';
              }
              ?>
            </ul>
          </li>
