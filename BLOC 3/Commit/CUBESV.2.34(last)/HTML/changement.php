...
?>
<?php  
if(isset($_POST)) { // Si l'utilisateur clique sur changer de mdp
        ...
        if ($row !== false && $_POST['email'] == $row['Email']) { // attention il faut vérifier l'ancien mot de passe aussi ALERT
...
?>
    ...
    <div class="container">
        ...
        <form method="POST" action="changement_mot_de_passe.php">
        <div class="mb-3">
